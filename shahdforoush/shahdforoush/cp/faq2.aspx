<%@ Page Title="" Language="C#" MasterPageFile="~/cp/master.master" AutoEventWireup="true" CodeFile="faq2.aspx.cs" Inherits="cp_faq" %>
					...
					<div style="direction:rtl;">
                        <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" 
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="سوالات" FieldName="title" 
                                    VisibleIndex="3" Width="277px">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="پاسخ ها" FieldName="detail" 
