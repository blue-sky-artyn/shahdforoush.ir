            ...
            if (Request.Cookies["ShoppingBasket"] != null)
            {
                ...
                if (value != "")
                {
                    ...
                    for (int i = 0; i < productID.Length; i++)
                    {
                        ...
                        for (int j = 0; j < listBasket.Count; j++)
                        {
                            ...
                            content += "<tr class='first_row' >" +
                                            ...
                                            "<td>" + price.ToString() + "تومان </td>" +
                                            
                                            "<td>0 تومان </td>" +
                                            "<td>" + pro[1] + "</td>" +
                                            "<td class='last_cell' style='text-align: left;'><a href='#' class='light-2' data-product-id='" + listBasket[j].id_profolio.ToString() + "' data-product-no='" + pro[1] + "' >حذف</a></td>" +
                                        "</tr>";
                    ...
                    content +=  "<tr class='first_row'>" +
                                ...
                                "<td colspan='5' style='text-align: center;' >جمع قابل پرداخت: <big style='color: red;'>" + totalPrice + " تومان</big></td>" +
                            "</tr>" +
                        "</table>";
