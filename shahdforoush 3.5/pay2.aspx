                        ...
                        <td>
                            <table class="MainTable" cellspacing="5" cellpadding="1" align="center">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="TerminalIdTextBox" runat="server" Text="2025"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="LabelTd">
                                    ...
                                    <td>
                                        <asp:TextBox ID="UserNameTextBox" runat="server" Text="Amir"></asp:TextBox><br />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="LabelTd">
                                    ...
                                    <td>
                                        <asp:TextBox ID="UserPasswordTextBox" runat="server" Text="0000"></asp:TextBox><br />
                                    </td>
                                </tr>
                            </table>
                            <hr />
                            <table class="MainTable" cellspacing="5" cellpadding="1" align="center">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="PayAdditionalDataTextBox" runat="server" Text="Add....Data"></asp:TextBox><br />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="LabelTd">
                                    ...
                                    <td>
                                        <asp:TextBox ID="PayCallBackUrlTextBox" runat="server" Text="http://www.yoursite.com/callback.aspx"></asp:TextBox><br />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="LabelTd">
