<%@ Page Title="فاکتور صادر شده" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="invoice_Bkp.aspx.cs" Inherits="invoice" %>
                                    ...
                                    <div class="span12 module_cont module_price_table">
                                        ...
                                        <div class="price_item" style="width:25%">
                                            <div class="price_item_wrapper">
                                                <div class="price_item_title"><h2>تخفیف خرید اینترنتی</h2></div>
                                                <div class="price_item_cost"><h1><span>%&nbsp;</span>2<span>/از کل</span></h1></div>
                                        ...
                                        <div class="price_item" style="width:25%">
                                            <div class="price_item_wrapper">
                                                <div class="price_item_title"><h2>تخفیف به مناسبت</h2></div>
                                                ...
                                                <div class="price_item_text" style="font-family:Tahoma;">سالروز پیروزی انقلاب</div>
                                                <div class="price_item_text" style="font-family:Tahoma;">پیروزی جنگ تحمیلی</div>
